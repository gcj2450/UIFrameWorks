...
public class PanelBase : MonoBehaviour
{
    ...
    public virtual void Show(float fade = 0.5f, SimpleTween.Callback callback = null)
    {
    ...
    /// <param name="direction">Direction – Back if we are returning from a sub-menu, Forward otherwise</param>
    /// <param name="callback">Callback to call once the transition is finished</param>
    public virtual void Show(System.Object sender, ChangeUIEventArgs args,float fade=0.5f, SimpleTween.Callback callback = null)
    {
        gameObject.SetActive(true);
    ...
    /// </summary>
    public virtual void Hide(float fade=0.5f, SimpleTween.Callback callback = null)
    {
