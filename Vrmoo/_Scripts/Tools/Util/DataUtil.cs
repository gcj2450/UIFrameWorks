...
public static class DataUtil {
	...
	/// <summary>
	/// Parameterses to json.
	/// </summary>
	/// <returns>The json data.</returns>
	/// <param name="param">Parameter.</param>
	//public static LitJson.JsonData ParamsToJson(params object []param)
	//{
	//	string sJson = param[0].ToString();
	//	LitJson.JsonData jdata = LitJson.JsonMapper.ToObject (sJson);
	//	return jdata;
	//}
	...
	//public static string JsonToString(LitJson.JsonData data , string key)
	//{
	//	if (data == null)
	//		return "";
	...
	/// <param name="data">Data.</param>
	/// <param name="key">Key.</param>
	//public static int JsonToInt(LitJson.JsonData data , string key)
	//{
	//	if (data == null || data [key] == null) {
	//		return 0;
	//	} else 
	//	{
	//		return StringToInt(data[key].ToString());
	//	}
	//}
