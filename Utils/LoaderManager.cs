...
public class LoaderManager : MonoBehaviour {
	...
	private Dictionary<string , Action<Texture2D>> loadMap;
	...
	void Awake()
	{
		...
		loadMap = new Dictionary<string ,Action<Texture2D>> ();
	}
	...
	public void StartLoad(string url , Action<Texture2D> callback ,int width, int hight)
	{
		url = url.Replace(" ", "%20");
	...
	private void LoadLocalFile(string url , Action<Texture2D> callback, int width, int hight)
	{
	...
	private void LoadNetFile(string url , Action<Texture2D> callback)
	{
